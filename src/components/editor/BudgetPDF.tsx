...
// Renderiza o HTML da proposta (editor rich text) como elementos do PDF.
// Suporta títulos, negrito/itálico/sublinhado, listas, citação e divisória.
// Também aceita texto puro (propostas antigas) — vira um parágrafo.
...
function renderRichNotes(html: string): any[] {
  if (!html) return [];
  // Sem tags HTML? Trata como texto puro (proposta antiga).
